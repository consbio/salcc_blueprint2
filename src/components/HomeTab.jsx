    ...
    <h2>Welcome to the Blueprint 2.1 Simple Viewer for Mobile</h2>
                ...
                <div>
                    <div className="flex-container2">
                        ...
                        <div className="flex-item2"> <b>  Highest priority:</b> the most important areas for natural and cultural resources based on
                    ...
                    <div className="flex-container2">
                        ...
                        <div className="flex-item2"><b>  High priority: </b>important areas for natural and cultural resources based on indicator
                    ...
                    <div className="flex-container2">
                        ...
                        <div className="flex-item2"><b>  Medium priority: </b>above-average areas for natural and cultural resources based on indicator
                    ...
                    <div className="flex-container2">
                        ...
                        <div className="flex-item2"><b>  Corridors: </b>connections between large patches of highest priority areas and secured lands,
                ...
                <div className="flex-container2">
                    <div className="flex-item2"> <img src={'/images/basemap.png'} height={40} alt=""/></div>
                    <div className="flex-item2"> toggle button and then text attribution</div>
                </div>
                <div className="flex-container2">
                    <div className="flex-item2"> <img src={'/images/basemap2.png'} height={40} alt=""/></div>
                    <div className="flex-item2"> toggle button and then text attribution</div>
                </div>
                <h4>Developed By</h4>
