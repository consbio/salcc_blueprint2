...
const PLANS = {
    ACJV: {
        ...
        description:
            'Atlantic Coast Joint Venture (ACJV)/ South Atlantic Migratory Bird Initiative (SAMBI) Priority Areas',
    ...
    TNC: {
        ...
        description:
            "The Nature Conservancy's (TNC) Ecoregional Priorities for the Mid-Atlantic Coastal Plain, South Atlantic Coastal Plain, and Piedmont",
    ...
    SAFMC_HAPC_wDeepwater_Coral: {
        ...
        description:
            'All habitat areas of particular concern (HAPC) from the South Atlantic Fisheries Management Council',
        url: 'http://safmc.net/',
        type: 'marine'
    },
    SnapperHAPC: {
        ...
        description:
            'Snapper habitat areas of particular concern (HAPC) from the South Atlantic Fisheries Management Council',
        url: 'http://safmc.net/',
        type: 'marine'
    },
    ViewSheds: {
